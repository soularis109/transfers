...
function Logo({ onClick }: LogoProps) {
  return (
    <Link className="logo" to="/" aria-label="На головну" onClick={onClick}>
      <svg
      ...
      >
        ...
        <g filter="url(#filter1_d_1_179)">
          ...
          />
          <path
            d="M41 12C56.464 12 69 24.536 69 40C69 55.464 56.464 68 41 68C25.536 68 13 55.464 13 40C13 24.536 25.536 12 41 12Z"
            stroke="#42A5F5"
            strokeWidth="4"
          />
        </g>
